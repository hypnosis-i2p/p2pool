...
nets = dict(
    ...
    digitalcoin=math.Object(
        ...
        BLOCK_EXPLORER_URL_PREFIX='http://chainz.cryptoid.info/dgc/block.dws?',
        ADDRESS_EXPLORER_URL_PREFIX='http://chainz.cryptoid.info/dgc/address.dws?',
        TX_EXPLORER_URL_PREFIX='http://chainz.cryptoid.info/dgc/tx.dws?',
        SANE_TARGET_RANGE=(2**256//1000000000 - 1, 2**256//1000 - 1),
        DUMB_SCRYPT_DIFF=2**16,
        DUST_THRESHOLD=0.03e8,
    ),
    ...
    anoncoin=math.Object(
        ...
        BLOCK_EXPLORER_URL_PREFIX = 'http://abe.darkgamex.ch:2751/block/',
        ADDRESS_EXPLORER_URL_PREFIX = 'http://abe.darkgamex.ch:2751/address/',
        TX_EXPLORER_URL_PREFIX = 'http://abe.darkgamex.ch:2751/tx/',
        SANE_TARGET_RANGE=(2**256//1000000000 - 1, 2**256//1000 - 1),
        DUMB_SCRYPT_DIFF=2**16,
        DUST_THRESHOLD=0.03e8,
    ),
